        ...
        <div
            ...
            <div className='flex flex-col justify-between ml-4'>
                <h3 className='font-bold text-xl text-teal-500'>{company} {isNew && (
                    <span
                        className='bg-teal-500 text-teal-100 font-bold rounded-full m-2 py-1 px-2 uppercase text-sm'>New</span>)} {featured && (
                    <span
                        className='bg-gray-800 text-white font-bold rounded-full py-1 px-2 uppercase text-sm'>Featured</span>)}</h3>
